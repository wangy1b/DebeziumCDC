 ...
 * semantics.
 *
 * <p>The SocketDynamicTableFactory illustrates how connector components play together. It
 * can serve as a reference implementation for implementing own connectors and/or formats.
 *
 * <p>The SocketDynamicTableSource uses a simple single-threaded {@link SourceFunction} to
...
public final class ChangelogSocketExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String srcSql = "CREATE TABLE UserScores (name STRING, score INT)\n"
                + "WITH (\n"
                + "  'connector' = 'socket',\n"
                + "  'hostname' = '" + hostname + "',\n"
                + "  'port' = '" + port + "',\n"
